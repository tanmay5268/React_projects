...
const Footer = () => {
    return (
        <div className='w-full'>
            <div className='max-w-7xl flex gap-10 py-25 mb-30 mx-auto w-full h-10 '>
                ...
                <div className='basis-1/2 flex gap-4'>
                    ...
                    <div className='basis-1/3 items-end flex flex-col gap-1' >
                    <p className='text-right -mt-5'> Refokus is pioneering digital agency driven by design and
