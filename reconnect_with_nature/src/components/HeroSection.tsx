...
const HeroSection = () => {
    return (
        <div style={{ backgroundImage: "url('https://www.reconnectwithnature.org/getContentAsset/f8d8e68d-bfaa-456b-a47c-c757bc5a9bde/dfc3d011-8f63-43f6-9ed8-4b444333a1d0/hero-Buzz-2022-2.jpg?language=en-US')" }} className=" z-0 w-screen h-119 relative overflow-hidden object-cover bg-cover bg-center">
